...
var user = User(userName: "Test", emailAdress: "test@gmail.com", discordAccount: "Test#1234", userAge: 20, aboutMe: "Passionné de jeux vidéo depuis toujours, je suis constamment à la recherche de nouveaux défis virtuels.")

// Création d'un tableau pour les utilisateurs
var tableauUser = [user]

//Création d'une structure contenant les "settingsUser"
...
//    var settingsUserDiscordAcc: String
//
//}
